...
namespace AppWords
{
    public static class Global
    {
        ...
        public static SolidColorBrush COLOR_PPLAYER1 = new SolidColorBrush { Color = Colors.Yellow};
        public static SolidColorBrush COLOR_ABC = new SolidColorBrush { Color = Colors.White};
        public static SolidColorBrush COLOR_AI = new SolidColorBrush { Color = Colors.Violet };

        public static SolidColorBrush NO_COLOR = new SolidColorBrush { Color = Colors.Transparent };
        public static SolidColorBrush DIALOG_COLOR = new SolidColorBrush { Color = Colors.Blue };
        ...
        public static string FILENAME_DICT_SEXWORD = @"dictSexWord.txt";
        ...
        public static int NUMBER_WORD_SEX = 6;
